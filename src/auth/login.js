...
//       setOtpSentMessage('OTP has been sent to your email. Please enter the OTP.');
//       setErrorMessage(''); 
...
//     try {
//       const otpResponse = await axios.post('http://localhost:8080/verify-otp', { email, otp });

//       if (otpResponse.data.auth_token) {
